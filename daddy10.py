...
\033[1;36m [\033[1;97m=\033[1;36m] POWER MASUM : DADDY\x1b[1;97m
\033[33;1m ──────────────────────────────────────────────────      
...
def mueor():
    ...
    with ThreadPool(max_workers=100) as MUEOR:
        ...
        print(logo)
        tl = str(len(user))
        print('\033[1;91m [\033[1;37m=\033[1;91m]\033[1;32m SIM CODE : '+nude)
        print('\033[1;91m [\033[1;37m=\033[1;91m]\033[1;32m DADDY SQUAD ')
        print('\033[1;91m [\033[1;37m=\033[1;91m]\033[1;32m TOOL CREATED BY ONLY JOIN MY GROUP ')
        print('\033[1;91m [\033[1;37m=\033[1;91m]\033[1;32m TOTAL ID : '+tl)
        for guru in user:
